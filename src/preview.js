export class PreviewPlayer {
    ...
    seek(time) {
        ...
        // If already rendering, schedule this time as pending
        if (this.isRendering) {
    ...
    async render(time, shouldSeek = true) {
        ...
        try {
            ...
            if (this.pendingRenderTime !== null) {
                const nextTime = this.pendingRenderTime;
                this.pendingRenderTime = null;
                // Use requestAnimationFrame to avoid stack overflow and allow UI updates
